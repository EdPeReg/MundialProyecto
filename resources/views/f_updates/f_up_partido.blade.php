    ...
    <div class="card">
        ...
        <div class="card-body px-lg-5">
            <form class="text-left" enctype="multipart/form-data" style="color: #757575"
                action="{{ route('PartidoUpdate', $partido) }}" method="POST">
                @csrf @method('PATCH')
                <div class="md-form">
                    <table width="100%">
                        <tr>
                        ...
                        <tr>
                            <td width="10%">
                                ...
                                <input value="{{ old('Resultado_eq1', $partido->Resultado_eq1) }}" type="number" name="Resultado_eq1"
                            ...
                            <td width="10%">
                                ...
                                <input value="{{ old('Resultado_eq2', $partido->Resultado_eq2) }}" type="number" name="Resultado_eq2"
