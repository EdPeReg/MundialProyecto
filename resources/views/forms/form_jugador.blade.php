    ...
    <div class="card">
        ...
        <div class="card-body px-lg-5">
            <form class="text-left" enctype="multipart/form-data" style="color: #757575"
                action="{{ route('JugadorStore') }}" method="POST">
                @csrf
                <div class="md-form">
                    <table width="100%">
                        <td>
                            <label for="materialNameJugador">Primer Nombre:</label>
                            <input value="{{ old('Nombre') }}" type="text" name="Nombre" id="materialNameJugador"
                                class="form-control">
                            {!! $errors->first('Nombre', '<small>:message</small><br>') !!} <br>
                        </td>
                        <td>
                            <label for="materialApellido">Apellido(s):</label>
                            <input value="{{ old('Apellido') }}" type="text" name="Apellido" id="materialApellido"
                                class="form-control">
                            {!! $errors->first('Apellido', '<small>:message</small><br>') !!} <br>
                        </td>
                        <td>
                            <label for="materialNum_i">Número de identificación:</label>
                            <input value="{{ old('Num_i') }}" type="number" min="0" pattern="\d+" step="1" name="Num_i"
                    ...
                    <table width="100%">
                        <td>
                            ...
                            <input value="{{ old('Nacionalidad') }}" type="text" name="Nacionalidad"
                    ...
                    <table width="100%">
                        <td>
                            ...
                            <input value="{{ old('Peso') }}" type="number" min="30" pattern="\d+" step="0.01"
                        ...
                        <td>
                            ...
                            <input value="{{ old('Altura') }}" type="number" min="100" pattern="\d+" step="0.1"
                    ...
                    <table width="100%">
                        ...
                        <td width="15%">
                            ...
                            <input value="{{ old('Num_playera') }}" type="number" min="0" pattern="\d+" step="1"
                        ...
                        <td width="15%">
                            ...
                            <input value="{{ old('Goles_mun') }}" type="number" min="0" pattern="\d+" step="1"
