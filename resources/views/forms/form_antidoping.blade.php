...
@section('title','Agregar Resultado Antidoping')
...
<div class="offset-1 col-10">
    <div class="card">
        ...
        <h5 class="card-header info-color white-text text-center py-4">
            <strong>Registrar Resultado Antidoping</strong>
        </h5>

        <div class="card-body px-lg-5">
            <form class="text-left" enctype="multipart/form-data" style="color: #757575" action="{{ route('AntidopingStore') }}"
                method="POST">
                @csrf
                <div class="md-form">
                    <table width="100%">
                        <tr>
                            <td>
                                ...
                                <input value="{{ old('Lugar') }}" type="text" name="Lugar" id="materialLugar" class="form-control">
